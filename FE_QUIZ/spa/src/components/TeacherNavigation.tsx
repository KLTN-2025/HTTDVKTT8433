...
import { isTeacher, getUserDisplayName } from '@/utils/apiTransform'
...
export const TeacherNavigation: React.FC = () => {
  ...
  if (loading || !user || !isTeacher(user)) {
    return null
  }
  ...
  const navigationItems = [
    { name: 'Dashboard', path: '/teacher/dashboard', icon: '🏡', color: 'from-amber-200 to-orange-200 hover:from-amber-300 hover:to-orange-300' },
    { name: 'Subjects', path: '/teacher/subjects', icon: '📖', color: 'from-cyan-200 to-blue-200 hover:from-cyan-300 hover:to-blue-300' },
    { name: 'My Quizzes', path: '/teacher/quizzes', icon: '📚', color: 'from-rose-200 to-pink-200 hover:from-rose-300 hover:to-pink-300' },
    { name: 'Create Quiz', path: '/teacher/create-quiz', icon: '✨', color: 'from-emerald-200 to-teal-200 hover:from-emerald-300 hover:to-teal-300' },
    { name: 'Take Quiz', path: '/teacher/quiz-taking', icon: '🎯', color: 'from-orange-200 to-red-200 hover:from-orange-300 hover:to-red-300' },
    { name: 'Review Quizzes', path: '/teacher/review-quizzes', icon: '🔄', color: 'from-purple-200 to-indigo-200 hover:from-purple-300 hover:to-indigo-300' },
    { name: 'Analytics', path: '/teacher/analytics', icon: '📊', color: 'from-violet-200 to-purple-200 hover:from-violet-300 hover:to-purple-300' }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center">
            <Link to="/teacher/dashboard" className="group flex items-center space-x-3 transform hover:scale-105 transition-all duration-500">
          ...
          <div className="flex items-center space-x-3">
            <div className="hidden lg:block text-right">
              ...
              <div className="text-xs font-rounded font-bold text-amber-700 animate-fade-in">✨ Teacher ✨</div>
            </div>
