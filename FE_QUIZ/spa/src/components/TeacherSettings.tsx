...
export default function TeacherSettings() {
  ...
  useEffect(() => {
    const savedTheme = localStorage.getItem('teacher-theme') as 'light' | 'dark' | 'auto' || 'light'
    const savedLanguage = localStorage.getItem('teacher-language') as 'vi' | 'en' || 'vi'
  ...
  const handleLanguageChange = (newLanguage: 'vi' | 'en') => {
    ...
    localStorage.setItem('teacher-language', newLanguage)
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center text-white hover:scale-110"
        ...
        <div className="teacher-settings-header">
          <div className="flex items-center justify-between relative z-10">
            ...
            <button
              ...
              className="text-white hover:text-pink-200 transition-all duration-300 transform hover:scale-110 w-12 h-12 bg-black bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-40 shadow-lg"
            >
                ...
                <form onSubmit={handlePasswordChange} className="space-y-4">
                  ...
                  <div className="flex gap-4">
                    <button
                      type="submit"
                      disabled={loading}
                      className="px-6 py-2 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-lg hover:from-red-600 hover:to-pink-600 disabled:opacity-50 transition-colors"
                    >
